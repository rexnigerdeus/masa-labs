...
- La feuille `labs-ui` est importée **par la page d'accueil** dans Vitae et Hive, pas par `globals.css` : l'éditeur, les offres et les annonces ne paient pas les kilo-octets d'un langage visuel qu'ils n'utilisent pas — [apps/vitae/app/accueil.css:1](apps/vitae/app/accueil.css#L1). Mesuré : 4,3 Ko gzip sur `/offres` contre 9,9 sur `/`.
